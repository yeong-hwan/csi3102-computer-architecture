...
void testALU()
{
    ...
    printWire("aluControl", aluControl);
    alu->advanceCycle();
...
void testALUControl()
{
    ...
    aluOp = 0;
    printWire("aluOp", aluOp);
    printWire("funct", funct);
...
void testControl()
{
    ...
    printWire("regDst", regDst);
    printWire("aluSrc", aluSrc);
    printWire("memToReg", memToReg);
    printWire("regWrite", regWrite);
    printWire("memRead", memRead);
    printWire("memWrite", memWrite);
    printWire("branch", branch);
    printWire("aluOp", aluOp);
...
void testRegisterFile()
{
    ...
    printWire("regWrite", regWrite);
    printWire("writeRegister", writeRegister);
    ...
    fprintf(stderr, "INFO: current register values:\n");
    regFile->printRegisters();
    fprintf(stderr, "INFO: regWrite = 0, readRegister1 = 0x0, readRegister2 = 0x1 --> readData1 = 0x00000000, "
                    "readData2 = 0x89abcdef\n");
    regWrite = 0;
    readRegister1 = 0;
    readRegister2 = 1;
    printWire("regWrite", regWrite);
    printWire("readRegister1", readRegister1);
    printWire("readRegister2", readRegister2);
    regFile->advanceCycle();
    printWire("readData1", readData1);
    printWire("readData2", readData2);
    fprintf(stderr, "INFO: regWrite = 0, readRegister1 = 0x2, readRegister2 = 0x3 --> readData1 = 0x02468ace, "
                    "readData2 = 0x13579bdf\n");
    regWrite = 0;
    readRegister1 = 2;
    readRegister2 = 3;
    printWire("regWrite", regWrite);
    ...
    printWire("readData1", readData1);
    printWire("readData2", readData2);
    fprintf(stderr, "INFO: regWrite = 0, readRegister1 = 0x4, readRegister2 = 0x2 --> readData1 = 0x00000000, "
                    "readData2 = 0x02468ace\n");
    regWrite = 0;
    readRegister1 = 4;
    readRegister2 = 2;
    printWire("regWrite", regWrite);
...
void testSingleCycleCPU(int argc, char **argv)
{
    ...
    else
    {
        ...
        SingleCycleCPU *cpu =
            new SingleCycleCPU("SingleCycleCPU", initialPC, regFileName, instMemFileName, dataMemFileName);
