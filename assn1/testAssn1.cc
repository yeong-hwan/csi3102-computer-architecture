...
void testNANDGate()
{
    ...
    fprintf(stderr, "##### Cycle 4: input0 = 0xF0, input1 = 0xFF --> output = 0x0F\n");
    input0 = (unsigned long long)0xF0;
    input1 = (unsigned long long)0xFF;
    printWire("input0", input0);
    printWire("input1", input1);
...
void testSignedAdder()
{
    ...
    input0 = (unsigned long long)0x0F;
    printWire("input0", input0);
    input1 = (unsigned long long)0x01;
    printWire("input1", input1);
    adder->advanceCycle();
    printWire("output", output);
    ...
    input0 = (unsigned long long)0x0F;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF8;
    printWire("input1", input1);
    adder->advanceCycle();
    printWire("output", output);

    fprintf(stderr, "##### Cycle 3: input0 = 0b00001000, input1 = 0b11110111 --> output = 0b11111111\n");
    input0 = (unsigned long long)0x08;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF7;
    printWire("input1", input1);
    adder->advanceCycle();
    printWire("output", output);
...
void testSignedSubtractor()
{
    ...
    input0 = (unsigned long long)0x0F;
    printWire("input0", input0);
    input1 = (unsigned long long)0x08;
    printWire("input1", input1);
    subtractor->advanceCycle();
    printWire("output", output);
    ...
    input0 = (unsigned long long)0x08;
    printWire("input0", input0);
    input1 = (unsigned long long)0x09;
    printWire("input1", input1);
    subtractor->advanceCycle();
    printWire("output", output);
...
void testLogicalUnit()
{
    ...
    fprintf(stderr, "##### Cycle 1: operation = 0b000, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0x00000000\n");
    operation = (unsigned long long)0;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    printWire("input1", input1);
    lu->advanceCycle();
    printWire("output", output);
    ...
    fprintf(stderr, "##### Cycle 2: operation = 0b001, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0xFFF0FFF0\n");
    operation = (unsigned long long)1;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    ...
    fprintf(stderr, "##### Cycle 3: operation = 0b010, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0x0FF00FF0\n");
    operation = (unsigned long long)2;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    ...
    fprintf(stderr, "##### Cycle 4: operation = 0b011, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0x00FF00FF\n");
    operation = (unsigned long long)3;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    ...
    fprintf(stderr, "##### Cycle 5: operation = 0b100, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0x0FFF0FFF\n");
    operation = (unsigned long long)4;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    ...
    fprintf(stderr, "##### Cycle 6: operation = 0b101, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0x000F000F\n");
    operation = (unsigned long long)5;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
    ...
    fprintf(stderr, "##### Cycle 7: operation = 0b110, input0 = 0xFF00FF00, input1 = 0xF0F0F0F0"
                    " --> output = 0xF00FF00F\n");
    operation = (unsigned long long)6;
    printWire("operation", operation);
    input0 = (unsigned long long)0xFF00FF00;
    printWire("input0", input0);
    input1 = (unsigned long long)0xF0F0F0F0;
...
void testHashTable()
{
    ...
    index = (unsigned long long)0;
    printWire("index", index);
    isWrite = (unsigned long long)1;
    printWire("isWrite", isWrite);
    input = (unsigned long long)0x01234567;
    ...
    index = (unsigned long long)2;
    printWire("index", index);
    isWrite = (unsigned long long)1;
    printWire("isWrite", isWrite);
    input = (unsigned long long)0x89ABCDEF;
    printWire("input", input);
    hashTable->advanceCycle();
    printWire("output", output);

    fprintf(stderr, "##### Cycle 3: index = 0b01, isWrite = 1, input = 0x0123CDEF --> output = 0x00000000\n");
    index = (unsigned long long)1;
    printWire("index", index);
    isWrite = (unsigned long long)1;
    printWire("isWrite", isWrite);
    input = (unsigned long long)0x0123CDEF;
    printWire("input", input);
    hashTable->advanceCycle();
    printWire("output", output);

    fprintf(stderr, "##### Cycle 4: index = 0b11, isWrite = 1, input = 0x89AB4567 --> output = 0x00000000\n");
    index = (unsigned long long)3;
    printWire("index", index);
    isWrite = (unsigned long long)1;
    printWire("isWrite", isWrite);
    input = (unsigned long long)0x89AB4567;
    printWire("input", input);
    hashTable->advanceCycle();
    printWire("output", output);
...
void testDelayQueue()
{
    ...
    isPush = (unsigned long long)1;
    printWire("isPush", isPush);
    input = (unsigned long long)0x01234567;
    printWire("input", input);
    ...
    isPush = (unsigned long long)0;
    printWire("isPush", isPush);
    input = (unsigned long long)0x89AB0123;
    printWire("input", input);
    delayQueue->advanceCycle();
    printWire("output", output);
