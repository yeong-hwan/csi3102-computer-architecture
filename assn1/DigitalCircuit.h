...
template <size_t N> using Register = std::bitset<N>;

template <size_t N> using Wire = std::bitset<N>;

template <size_t N> void printWire(const std::string &name, const Wire<N> &wire)
{
